...
namespace StudentManagementSystem
{
    public partial class Home : Form
    {
        ...
        private void DynamicButton_Click(object sender, EventArgs e)
        {
            ...
            (this.Owner as ToolMenu).pnTool.Controls.Clear();
            MenuForm Menu = new MenuForm();
            Menu.Owner = (this.Owner as ToolMenu);
            Menu.TopLevel = false;
            Menu.AutoScroll = true;
            (this.Owner as ToolMenu).pnTool.Controls.Add(Menu);
            Menu.Show();
            //(this.Owner as ToolMenu).btnClass.Hide();
            (this.Owner as ToolMenu).lbMainName.Text = "Menu";
        ...
        private void btnSetting_Click(object sender, EventArgs e)
        {
            ...
            btnOption= btnSetting.Text;
            s.Owner = (this.Owner as ToolMenu);
            s.Show();
        }

        public void ClickClass(object sender, EventArgs e)
        {
        ...
        private void ChangeLanguage()
        {
            ...
            if (Op == "    ជម្រើស")
            {
                ...
                btnSetting.Font = new Font("Khmer OS Bokor", 12, FontStyle.Regular);

                btnNewClass.Text = "បន្ថែមថ្នាក់";
                btnSetting.Text = "កំណត់";
            }
        }
    }
}
